 ...
 * @returns {Promise}
 */
openCatalog.prototype.getProduct = function(lang, GTIN, accessToken, contentToken) {
  const httpRequestUrl = this._getBaseUrl(lang) + ';ean_upc=' + GTIN;

  return this._requestProduct(httpRequestUrl, accessToken, contentToken);
};
 ...
 * @param {string} sku
 */
openCatalog.prototype.getProductBySKU = function(lang, brand, sku,accessToken, contentToken) {
 ...
 * @returns {Promise}
 */
openCatalog.prototype._requestProduct = function(httpRequestUrl, accessToken, contentToken) {
  return new Promise((resolve, reject) => {
